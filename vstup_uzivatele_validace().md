...
<br>
Pokud není ani jedna podmínka splnena, pak je funkce ukoncena s návratovou hodnotou císla možnosti, dle nabídky v [hlavni_menu()](https://github.com/jonasRower/Testing-Engeto-Project-1/blob/main/hlavni_menu())<br>
